...
function App() {
  ...
  if (rawData.length === 0) {
    return (
      <div className="min-h-screen bg-linear-to-br from-primary/5 via-accent/10 to-secondary/15 p-6 flex flex-col">
          ...
          <div className="max-w-5xl w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto mb-12 leading-relaxed">
                A comprehensive analytics tool to visualize and understand how
                Swedish English teachers adapt their lessons for students
        ...
        <footer className="mt-12 text-center text-sm text-foreground/60">
          ...
          <Heart
            size={14}
            weight="fill"
            className="inline text-destructive mx-1"
          />{" "}
          by Jon
        </footer>
      </div>
            ...
            <div>
              {filteredData.length === 0 ? (
                <Alert>
                  <Info className="h-4 w-4" />
                  <AlertDescription>
                    No data matches current filters. Try adjusting your filter
                    selections.
                  </AlertDescription>
                </Alert>
              ) : (
